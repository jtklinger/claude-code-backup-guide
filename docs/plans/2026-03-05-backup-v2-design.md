...
- **Extra context files** — additional `*.md` files in `~/.claude/` (e.g., `HOMELAB-CONTEXT.md`)
...
| Global settings | `~/.claude/*.md` (extra context) | `global/*.md` | e.g., HOMELAB-CONTEXT.md |
...
```json
{
  ...
  "projects": [
    ...
    "C--Users-jtkli-projects-claude-code-backup-guide",
    "C--Users-jtkli-projects"
  ],
  "git_auto_push": true,
  "git_remote": "origin",
  "git_branch": "main"
