...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File "C:\Users\jtkli\projects\claude-code-backup-guide\scripts\windows\install.ps1" -Fast -Silent
```
...
$bash = New-ScheduledTaskAction -Execute "C:\Program Files\Git\bin\bash.exe" `
    -Argument '-l -c "bash /c/Users/jtkli/projects/claude-code-backup-guide/scripts/backup.sh /c/Users/jtkli/claude-code-backup"'
